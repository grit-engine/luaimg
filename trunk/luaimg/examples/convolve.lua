...
((lena - gaussian_blurred)*vec(10,10,10)):save("output_test16_gaussian_diff.png")

unsharp_mask = make(gaussian.size,1,false,function(pos) return pos == vec(3,3) and 2 or 0 end) - gaussian ;
lena:convolve(unsharp_mask):save("output_test16_unsharpmask.png")

sep_gaussian_x = make(vec(7,1),1,false,{ 1, 6, 15, 20, 15, 6, 1 }):normalise()
