...
a = make(vector2(256,256),4,function(p) return vector4(0, 1, 0, p.x/255) end)
b = make(vector2(256,256),4,function(p) return vector4(1, 0, 0, p.y/255) end)
a:drawImage(b,vector2(0,0))
a:save("test14_drawimage.png")

lena = open("lena.jpg")
icon_sz = vector2(32,32)
lena_small = lena:scale(icon_sz, "LANCZOS3"):map(4, function(v, pos)
    a = #(pos - icon_sz/2)
...
dst:save("test14_drawimage2.png")
